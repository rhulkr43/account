...
<div class="container">
	<div class="row" style="margin-top: 3%;">
		...
		<div class="card" >
    <div class="card-header card bg-primary text-white">Payment  Type</div>
    <div class="card-body">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="name" placeholder="Account Amount" name="name">
    </div>
    <div class="form-group">
      <label for="pwd">Amount</label>
      <input type=""text"" class="form-control" id="amount" placeholder="Account Remark" name="amount">
    </div>
    <div class="form-group">
